# SecureCloud: S3 Baseline Solutions
# What is our page about 
Our page is all about keeping your data safe in the cloud, specifically focusing on S3 buckets in services like AWS. These buckets are incredibly useful for storing and sharing files, but they can also be risky if not configured properly. You might have heard stories about data leaks due to misconfigured S3 buckets.

That's where our S3 Baseline Project comes in. We're here to provide clear guidelines for securing your S3 buckets, whether you're a big bank needing top-level security or a small retail business looking to protect your customer data while still sharing some information publicly.

Our baseline guideline has a few key goals:

- Actionable Baselines: We offer practical steps that administrators can take to secure their S3 buckets.
- Built on NIST Guidelines: Our baseline is based on the applicable family control in the NIST 800-53 guideline, ensuring that our recommendations align with industry standards and best practices.
